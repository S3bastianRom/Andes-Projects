...
class Copa(iProducto):
    #Methods
    def __init__(self, nombre:str,precio_publico:float, ingredientes:list, tipo_vaso:str)->None:
        super().__init__()
    ...
    #Getter and setter tipo_vaso is str
    @property
